...
export class ViewModel {
    constructor(shell, monitor, keyboard) {
        ...
        this.lightElem = document.querySelector('#light');
        this.lineElems = [];
        this.keyElems = {};
        this.keydown = null;
        this.onKeyDown = (e) => {
            var _a;
            (_a = this.keydown) === null || _a === void 0 ? void 0 : _a.call(null, e);
    ...
    onKeyboardLitKeysUpdated(litKeys) {
        ...
        for (let key of litKeys) {
            (_a = this.getKeyElem(key)) === null || _a === void 0 ? void 0 : _a.classList.add('on');
        }
    }
    getConfig() {
        return this.config;
